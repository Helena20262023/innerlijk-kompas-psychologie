...
export default function PrivacyInformatie() {
  useEffect(() => {
    document.title = "Privacy-informatie voor cliënten | Innerlijk Kompas Psychologie";
  }, []);
  return (
    <div className="pt-20">
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              <Link href="/privacy">
                <span className="inline-flex items-center text-sm text-muted-foreground hover:text-primary transition-colors cursor-pointer mb-8 gap-1">
                  <ArrowLeft size={16} /> Terug naar privacyverklaring
                </span>
              </Link>
              <h1 className="text-3xl md:text-4xl font-serif text-foreground mb-4">Uw privacy</h1>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Alleen met uw toestemming mag ik informatie verstrekken aan de huisarts/verwijzer of eventueel aan een behandelaar naar wie ik u doorverwijs. Telkens als er daadwerkelijk informatie wordt gedeeld, zal ik u opnieuw om toestemming vragen, zodat u weet welke informatie ik met welk doel deel en met wie. Bij bezwaar zal ik de informatie niet verstrekken.
                </p>

                <h3 className="text-base font-semibold text-foreground mb-2 mt-5">Zorgverzekeraars</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="leading-relaxed">• Ik ben wettelijk verplicht om een aantal van uw persoons- en behandelgegevens vast te leggen. Een deel van deze gegevens komt ook op de rekening voor de zorgverzekeraar te staan (zoals naam, adres, woonplaats, bsn). Met ingang van 2022 ben ik ook verplicht om de zorgvraagtypering vast te leggen en op de rekening naar de zorgverzekeraar te vermelden.</li>
                  <li className="leading-relaxed">• Als u hier bezwaar tegen heeft, kunt u een privacyverklaring ondertekenen. De privacyverklaring dient vóór de eerste factuur (dus binnen 1 maand na de start van de behandeling) ingevuld te zijn.</li>
                  <li className="leading-relaxed">• Voor sommige behandelingen heeft u alleen recht op vergoeding als uw zorgverzekeraar hier vooraf toestemming voor heeft gegeven (machtiging). U bent als patiënt zelf verantwoordelijk voor de machtiging.</li>
                  <li className="leading-relaxed">• Zorgverzekeraars mogen controleren of mijn administratie op orde is en de rekeningen kloppen. Ik ben verplicht hieraan mee te werken, maar alleen als aan een aantal strikte wettelijke voorwaarden is voldaan.</li>
                </ul>

                <h3 className="text-base font-semibold text-foreground mb-2 mt-5">Nederlandse Zorgautoriteit (NZa)</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="leading-relaxed">• De NZa ontvangt gegevens over declaraties in de ggz via Vektis. Als u de privacyverklaring heeft ondertekend, verstrek ik deze gegevens niet aan uw zorgverzekeraar en komen ze dus ook niet bij de NZa terecht.</li>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ggz-aanbieders zijn wettelijk verplicht om een zorgvraagtypering te doen. Hiervoor gebruik ik de HoNOS+-vragenlijst. Daarnaast kan ik u, als dit in de behandeling past, aan het begin, tussentijds en aan het eind van de behandeling vragen om digitaal een vragenlijst in te vullen. Deze informatie komt in uw dossier.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Eens in de vijf jaar vindt er in mijn praktijk een interne kwaliteitscontrole plaats, visitatie genoemd. Dit gebeurt door collega's die net als ik een wettelijk beroepsgeheim hebben. Als u bezwaar heeft tegen inzage van uw dossier in het kader van deze visitatie, dan kunt u dat aan mij doorgeven.
                </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  Mochten andere personen of instanties informatie vragen over uw behandeling, dan ben ik niet verplicht die te geven. Ik heb er in ieder geval uw gerichte toestemming voor nodig. Denk aan een verzoek van een bedrijfsarts, een arbeidsongeschiktheidsverzekeraar of een letselschadeverzekeraar.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Ook als u toestemming geeft om informatie aan een derde te verstrekken, moet ik een eigen afweging maken of dit gezien mijn beroepsgeheim geoorloofd is.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Als u vindt dat bepaalde gegevens in uw dossier niet kloppen, dan kunt u mij vragen deze te wijzigen, corrigeren of aan te vullen. Het gaat hierbij alleen om feitelijke onjuistheden. Ik reageer binnen één maand op uw verzoek.
                </p>

                <h3 className="text-base font-semibold text-foreground mb-2">Recht op vernietiging</h3>
                <p className="text-muted-foreground leading-relaxed">
                  U kunt schriftelijk verzoeken (een deel van) uw gegevens uit uw behandeldossier te laten vernietigen. Ik reageer dan binnen een maand op uw verzoek. Voor uw gegevens in mijn administratie geldt dat ik deze vanwege fiscale wetgeving langer moet bewaren.
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-border/30">
                <p className="text-sm text-muted-foreground">
                  Deze informatie is voor het laatst bijgewerkt op {new Date().toLocaleDateString('nl-NL', { day: 'numeric', month: 'long', year: 'numeric' })}.
                </p>
              </div>
            </motion.div>
          </div>
