          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  De Geschilleninstantie is onafhankelijk en onpartijdig. De geschilleninstantie geeft binnen 6 maanden een oordeel over het geschil. De uitspraak van de geschilleninstantie is bindend voor alle partijen. U als cliënt en ik als zorgaanbieder kunnen hiertegen dus niet in beroep.
                </p>
              </div>
